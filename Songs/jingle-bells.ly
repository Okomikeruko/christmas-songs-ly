jingleBellsMelody = \relative d' {
    \key g \major
    d   b' a   g  | d2.     d8 d | d4  b' a    g  | e2. e4  | \break
...
jingleBellsVerseThree = \lyricmode {
    \set stanza = "3. "
